...
/**
 * 范围选择月视图 点击后立即选中当前所在行
 * zp
 */
public abstract class RangeMonthView2 extends BaseMonthView {

    public RangeMonthView2(Context context) {
        super(context);
    }
    ...
    public void onClick(View v) {
        ...
        List<Calendar> calendars = CalendarUtil.getWeekCalendars(index,
                mDelegate);
        if (calendars == null || calendars.size() != 7) {
            return;
        }
        if (calendars.get(0) == null || calendars.get(6) == null) {
            return;
        }
